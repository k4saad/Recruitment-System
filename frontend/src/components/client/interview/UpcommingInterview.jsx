...
import { getAllRequirementsForTable, getUpcommingInterviews } from "../../utils/apiFunctions";
                ...
                <div className="mx-0 flex flex-col">
                  ...
                  {isLoading ? (
                    ...
                    <div className="grid grid-cols-2 lg:flex-row justify-around">
                      {currentInterviews.map((requirement) => (
                        <RequirementInterviewCard requirement={requirement} key={requirement.requirementId} />
                      ))}
                    </div>
                  )}
                </div>
